...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'RESTful APIs', icon: HiShare },
      { name: 'Microservices', icon: HiCollection },
      { name: 'OpenAPI/Swagger', icon: HiDocumentReport },
      { name: 'Swagger UI', icon: HiDocumentReport },
  ...
  },
  {
    ...
    icon: HiCloud,
    skills: [
      { name: 'AWS EC2', icon: HiCloud },
      { name: 'AWS ECS', icon: HiCloud },
      { name: 'AWS Lambda', icon: HiCloud },
      { name: 'AWS S3', icon: HiCloud },
      { name: 'AWS IAM', icon: HiCloud },
      { name: 'AWS CloudWatch', icon: HiCloud },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Maven', icon: HiCode },
      { name: 'Git', icon: SiGit },
    ],
  },
  {
    title: 'Databases, Messaging & Caching',
    icon: HiDatabase,
    skills: [
      { name: 'PostgreSQL', icon: SiPostgresql },
      { name: 'SQL Optimization', icon: HiTrendingUp },
      { name: 'Data Modeling', icon: HiCollection },
      { name: 'Hibernate/JPA', icon: HiDatabase },
      { name: 'Redis', icon: HiServer },
      { name: 'Apache Kafka', icon: HiShare },
    ],
  },
  {
    title: 'Security & API Reliability',
    icon: HiLightningBolt,
    skills: [
      { name: 'Spring Security', icon: HiCode },
      { name: 'OAuth 2.0', icon: HiCode },
      { name: 'JWT', icon: HiCode },
      { name: 'Secure Coding', icon: HiCode },
      { name: 'API Security', icon: HiCode },
      { name: 'Input Validation', icon: HiClipboardList },
      { name: 'Error Handling', icon: HiCog },
    ],
  },
  {
    ...
    icon: HiChartBar,
    skills: [
      { name: 'Postman', icon: HiDocumentReport },
      { name: 'JUnit', icon: HiClipboardList },
      { name: 'Mockito', icon: HiClipboardList },
      { name: 'Unit Testing', icon: HiClipboardList },
      { name: 'Integration Testing', icon: HiClipboardList },
      { name: 'Debugging', icon: HiCode },
      { name: 'Logging', icon: HiDocumentReport },
      { name: 'Monitoring', icon: HiChartBar },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Code Reviews', icon: HiClipboardList },
...
const topSkills = [
  ...
  { name: 'AWS & Cloud Engineering', level: 90 },
